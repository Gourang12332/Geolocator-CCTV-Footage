      ...
      <div className="container mx-auto px-4">
        <div className="mb-12 grid gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="mb-4 text-2xl font-bold">Detective</h3>
            <p className="text-gray-400">
            This project aims to enhance security by tracking and geolocating individuals across multiple CCTV cameras. 
            </p>
          ...
          <div>
            ...
            AI-Powered CCTV Tracking and Geolocation System
            </p>
